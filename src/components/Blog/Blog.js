        ...
        <div>
            <div className='pt-36 grid lg:grid-cols-2 w-4/5 mx-auto gap-6'>
                <div className='shadow-xl rounded-xl p-6'>
                    <h3 className='text-center mb-3    text-xl lg:text-3xl  font-bold'>What is cors?</h3>
                    <p className='text-justify p-6'>Cross-Origin Resource Sharing (CORS) is an HTTP-header based mechanism that allows a server to indicate any origins (domain, scheme, or port) other than its own from which a browser should permit loading resources. CORS also relies on a mechanism by which browsers make a "preflight" request to the server hosting the cross-origin resource, in order to check that the server will permit the actual request. In that preflight, the browser sends headers that indicate the HTTP method and headers that will be used in the actual request.
                        <br />
                ...
                <div className='shadow-xl rounded-xl p-6'>
                    <h3 className='text-center mb-3    text-xl lg:text-3xl  font-bold'>How does the private route work?</h3>
                ...
                <div className='shadow-xl rounded-xl p-6'>
                    <h3 className='text-center mb-3    text-xl lg:text-3xl  font-bold'>Why are you using firebase? What other options do you have to implement authentication?</h3>
                    <p className='text-justify p-6'>
